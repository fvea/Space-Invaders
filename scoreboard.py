...
class Scoreboard(object):
    ...
    def prep_level(self):
        ...
        currentLevel = 'Level: ' + str(self.stats.level)
        self.level_img = self.font.render(currentLevel,True, 
    ...
    def prep_high_score(self): 
        ...
        self.high_score_img = self.font.render("High Score: " + high_score_str,
